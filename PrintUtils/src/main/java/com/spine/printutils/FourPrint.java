...
*/
    ...
    public void printCustom3(final String msg1, String msg2, final int size, final int align) {
        //Print config "mode"
...
//        new Thread(new Runnable() {
        ...
        //            try {
        byte[] b15 = new byte[]{0x1B, 0x21, 0x15}; // 2- bold with medium text
        byte[] b25 = new byte[]{0x1B, 0x21, 0x25}; // 2- bold with medium text
        ...
        switch (size) {
            ...
            case 15:
                ...
                printdata = concat(printdata, b15);
            ...
            case 25:
                ...
                printdata = concat(printdata, b25);
        ...
        String msgdot=":";
        printdata = concat(printdata, (msg1).getBytes());
        printdata = concat(printdata, new String(new char[12-msg1.length()]).replace("\0", " ").getBytes());
        printdata =concat(printdata,(msgdot).getBytes());
        printdata = concat(printdata, new String(new char[14-msg2.length()]).replace("\0", " ").getBytes());
        printdata =concat(printdata,(msg2).getBytes());
        printdata = concat(printdata, new String(new char[4]).replace("\0", " ").getBytes());
...
//                }
    ...
    public void printCustom2(final String msg, final int size, final int align) {
        //Print config "mode"
...
//                }
    ...
    public void printCenterStartingTest(final String msg, final int size) {
        //Print config "mode"
...
//        SPEED = new byte[]{0x1B,0x44,2,35,68,00};
//
//        printdata = concat(printdata, SPEED);
        ...
        printdata = concat(printdata, new String(new char[40]).replace("\0", " ").getBytes());
        printdata = concat(printdata, (msg).getBytes());
        printdata = concat(printdata, PrintService.FEED_LINE);
...
//                }
    ...
    public String FourColumAligh(String str1, String str2, String str3, String str4) {
        ...
        if (str1.length() >= C1) {
            str1 = str1.substring(0, C1);
        } else if (str2.length() >= C2) {
            str2 = str2.substring(0, C2);
        } else if (str3.length() >= C3) {
            str3 = str3.substring(0, C3);
        } else if (str4.length() >= C4) {
            str4 = str4.substring(0, C4);
        }
...
//        }
    ...
    public void ItemNamePrint(String str1) {
        printdata = concat(printdata, PrintService.ESC_ALIGN_LEFT);
        printdata = concat(printdata, new String(new char[5]).replace("\0", " ").getBytes());
        printdata = concat(printdata, str1.getBytes());
        printdata = concat(printdata, PrintService.FEED_LINE);
    }

    public void SevenColumAlighPrint(String str1, String str2, String str3, String str4, String str5, String str6, String str7) {
        ...
        byte[] b = new byte[]{0x1B, 0x21, 0x02};

        printdata = concat(printdata, b);


        printdata = concat(printdata, str1.getBytes());
        printdata = concat(printdata, new String(new char[4 - str1.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, new String(new char[1]).replace("\0", " ").getBytes());

        printdata = concat(printdata, str2.getBytes());
        printdata = concat(printdata, new String(new char[9 - str2.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, new String(new char[1]).replace("\0", " ").getBytes());


        printdata = concat(printdata, str3.getBytes());
        printdata = concat(printdata, new String(new char[8 - str3.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, new String(new char[1]).replace("\0", " ").getBytes());
        ...
        printdata = concat(printdata, new String(new char[11 - str5.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, str5.getBytes());
        printdata = concat(printdata, new String(new char[1]).replace("\0", " ").getBytes());


        printdata = concat(printdata, new String(new char[8 - str6.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, str6.getBytes());
        printdata = concat(printdata, new String(new char[1]).replace("\0", " ").getBytes());


        printdata = concat(printdata, new String(new char[11 - str7.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, str7.getBytes());
        printdata = concat(printdata, PrintService.FEED_LINE);
...
//        }
    ...
    public void SixColumAlighPrint(String str1, String str2, String str3, String str4, String str5, String str6) {
        ...
        SPEED = new byte[]{0x1B, 0x44, 2, 20, 26, 36, 50, 60, 00};
        ...
        //        outputStream.write(SPEED);
        printdata = concat(printdata, new String(new char[5 - str2.length()]).replace("\0", " ").getBytes());
        ...
        //        outputStream.write(SPEED);
        printdata = concat(printdata, new String(new char[9 - str3.length()]).replace("\0", " ").getBytes());
        ...
        printdata = concat(printdata, SPEED);
        printdata = concat(printdata, new String(new char[13 - str4.length()]).replace("\0", " ").getBytes());
        ...
        printdata = concat(printdata, SPEED);
        printdata = concat(printdata, new String(new char[9 - str5.length()]).replace("\0", " ").getBytes());
...
//        outputStream.write(PrintService.FEED_LINE);
        ...
        printdata = concat(printdata, new String(new char[9 - str6.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, str6.getBytes());
        printdata = concat(printdata, PrintService.FEED_LINE);
...
//        }
    ...
    public void IndexColumnPrint(String index, String str2) {
        ...
        printdata = concat(printdata, SPEED);
        Log.v("sssssssssssssss", str2.length() + " ");
        printdata = concat(printdata, new String(new char[30 - str2.length()]).replace("\0", " ").getBytes());
        printdata = concat(printdata, str2.getBytes());
        printdata = concat(printdata, PrintService.FEED_LINE);
...
//        }
    ...
    public void IndexColumnPrint80() {
        String index = "50", str2 = "50";
        if (str2.length() > 36) {
            str2 = str2.substring(0, 36);
        }
        if (index.length() > 36) {
        ...
        SPEED = new byte[]{0x1B, 0x44, 0, 50, 00};
...
//        }
    ...
    public void IndexColumnPrint85() {
        String index = "85", str2 = "85";
        if (str2.length() > 36) {
            str2 = str2.substring(0, 36);
        }
        if (index.length() > 36) {
        ...
        SPEED = new byte[]{0x1B, 0x44, 5, 70, 00};
...
//        }
    ...
    public void IndexColumnPrint75() {
        String index = "75", str2 = "75";
        if (str2.length() > 36) {
            str2 = str2.substring(0, 36);
        }
        if (index.length() > 36) {
        ...
        SPEED = new byte[]{0x1B, 0x44, 5, 65, 00};
...
//        }
    ...
    public void IndexColumnPrint75C() {
        String index = "75", str2 = "75";
        if (str2.length() > 36) {
            str2 = str2.substring(0, 36);
        }
...
//        }
    ...
    public void IndexColumnPrint75R() {
        String index = "75", str2 = "75";
        if (str2.length() > 36) {
            str2 = str2.substring(0, 36);
        }
