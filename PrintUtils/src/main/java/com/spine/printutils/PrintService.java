...
public class PrintService {
    ...
    public static byte[] FEED_PAPER_AND_CUT = {0x1D, 0x56, 56, 0x00};
    public static byte[] PAPER__CUT = {0x1D, 0x56, 0, 0x00};
    public static byte[] SELECT_CYRILLIC_CHARACTER_CODE_TABLE = {0x1B, 0x74, 0x11};
    public static byte[] LEFT_MARGIN = {0x1D, 0x4C, 10, 0};

    public static byte[] SELECT_BIT_IMAGE_MODE = {0x1B, 0x2A, 33, -128, 0};
    public static byte[] SET_LINE_SPACING_24 = {0x1B, 0x33, 24};
    public static byte[] SET_LINE_SPACING_30 = {0x1B, 0x33, 30};
    public static byte[] SELECT_BIT_IMAGE_MODE2 = {0x1B, 0x2A, 33, -128, 3};
